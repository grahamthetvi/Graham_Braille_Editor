...
const NEW_SHAPES: InventoryShapeKind[] = ['flower', 'iceSkates', 'vampireFangs', 'paintbrush', 'hiking', 'axe', 'beach', 'birdHouse', 'bowling', 'movieProjector', 'candle', 'cloudLightning', 'actingMask', 'mustache'];
